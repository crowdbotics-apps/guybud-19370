"""guybud_19370 URL Configuration
...
admin.site.site_header = "Guybud"
admin.site.site_title = "Guybud Admin Portal"
admin.site.index_title = "Guybud Admin"

# swagger
api_info = openapi.Info(
    title="Guybud API",
    default_version="v1",
    description="API documentation for Guybud App",
)
